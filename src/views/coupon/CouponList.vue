...
const {
  ...
  getList: couponStore.getCouponListAction,
  ...
  delete: couponStore.deleteCouponAction,
  updateStatus: couponStore.updateCouponStatusAction
})
...
const {
  ...
  getData,
  update: couponStore.updateCouponAction,
  create: couponStore.createCouponAction,
