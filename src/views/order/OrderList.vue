...
import { showModal, showPrompt, toast } from '@/utils/util'
...
const {
  ...
  getList: orderStore.getOrderListAction,
  ...
  delete: orderStore.deleteOrderAction
})
...
const InfoModalRef = ref<any>(null)
const info = ref(null)
...
// 退款处理
const handleRefund = (id: number, agree: any) => {
  ;(agree
    ...
    orderStore.refundOrderAction(id, data).then(res => {
      getData()
      toast('操作成功')
    })
  })
