...
const {
  ...
  getList: levelStore.getUserLevelListAction,
  delete: levelStore.deleteUserLevelAction,
  updateStatus: levelStore.updateUserLevelStatusAction
})
...
const {
  ...
  getData,
  update: levelStore.updateUserLevelAction,
  create: levelStore.createUserLevelAction
})
</script>
