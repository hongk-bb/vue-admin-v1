...
const {
  ...
  getList: goodsStore.getGoodsListAction,
  ...
  delete: goodsStore.deleteGoodsAction,
  updateStatus: goodsStore.updateGoodsStatusAction
})
...
const {
  ...
  getData,
  update: goodsStore.updateGoodsAction,
  create: goodsStore.createGoodsAction
})
...
categoryStore
  ...
  .then((res: any) => (category_list.value = res))
