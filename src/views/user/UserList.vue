...
const {
  ...
  getList: userStore.getUserListAction,
  ...
  delete: userStore.deleteUserAction,
  updateStatus: userStore.updateUserStatusAction
})
...
const {
  ...
  getData,
  update: userStore.updateUserAction,
  create: userStore.createUserAction
})
</script>
